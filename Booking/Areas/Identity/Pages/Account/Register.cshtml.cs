...
namespace Booking.Areas.Identity.Pages.Account
{
    public class RegisterModel : PageModel
    {
        ...
        public class InputModel
        {
            ...
            [RegularExpression(@"^[A-Za-z\s\-]{2,30}$", ErrorMessage = "Ime smije sadržavati samo slova i razmake.")]
            [Display(Name = "Ime")]
            public string Ime { get; set; }


            [Required(ErrorMessage = "Prezime je obavezno.")]
            [RegularExpression(@"^[A-Za-z\s\-]{2,30}$", ErrorMessage = "Prezime smije sadržavati samo slova i razmake.")]
